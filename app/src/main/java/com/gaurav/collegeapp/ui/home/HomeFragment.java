package com.gaurav.collegeapp.ui.home;
...
import com.gaurav.collegeapp.R;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sliderLayout.setSliderTransformAnimation(SliderAnimations.SPINNERTRANSFORMATION);
    ...
    private void openMap() {
        Uri uri = Uri.parse("geo:0, 0?q=CMR Institute Of Technology  Bangalore");
